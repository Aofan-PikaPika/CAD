...
namespace DAL
{
    public class ScaffordParaHandle
    {
        ...
        public bool AddPara(int pro_Id)
        {
            ...
            string sqlInsert= "insert into tb_scaffoldPara(pro_id,sca_type,con_layers,act_layers,base_type,soil_types,rough_level,cha_value,pad_area,anchor_style,anchor_type,anchor_model,anchor_connect,sca_situation,bui_status,bui_distance ,per_brace,per_level,per_set,la,lb,h)"
